...
# Archivos
salida_dir = os.path.join(directorio, "tests/comparator/salida.xlsx")
objetivo_dir = os.path.join(directorio, "tests/comparator/objetivo.xlsx")
resultado_dir = os.path.join(directorio, "tests/comparator/resultado.xlsx")
# Archivos
